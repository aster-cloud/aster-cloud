---
title: "WebSocket Preview Endpoint"
description: "The preview WebSocket endpoint allows developers to evaluate CNL policy source in real time without deploying it to the engine."
updated: 2026-06-02
apiVersion: v1
---
...
<Callout type="warning" title="Preview Tenant">
