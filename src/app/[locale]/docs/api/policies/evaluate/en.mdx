...
description: "Evaluate a deployed policy by module and function name. The policy must already be deployed to the engine before it can be called through this endpoint."
updated: 2026-06-02
apiVersion: v1
---
