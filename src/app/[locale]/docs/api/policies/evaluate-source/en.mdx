---
title: "Evaluate Policy from Source"
description: "Compile and evaluate a CNL (Controlled Natural Language) policy source string on the fly, without requiring the policy to be deployed first."
updated: 2026-06-02
apiVersion: v1
---
...
See [Authentication](/docs/getting-started/authentication) for full details on computing the HMAC signature.
