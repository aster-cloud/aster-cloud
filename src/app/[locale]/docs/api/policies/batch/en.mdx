---
title: "Batch Evaluate Policies"
description: "Evaluate up to 100 policy calls in a single HTTP request. Each item in the batch is an independent evaluation request."
updated: 2026-06-02
apiVersion: v1
---
