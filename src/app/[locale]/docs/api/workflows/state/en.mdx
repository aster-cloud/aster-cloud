...
description: "Retrieve the current materialized state of a workflow. The state is derived from the workflow's event log and may be supplemented by a periodic snapshot…"
updated: 2026-06-02
apiVersion: v1
---
