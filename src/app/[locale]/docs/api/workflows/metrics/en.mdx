...
description: "Operational endpoints for monitoring workflow health across the tenant. Use these to build dashboards, set up alerting thresholds, or identify stuck…"
updated: 2026-06-02
apiVersion: v1
---
