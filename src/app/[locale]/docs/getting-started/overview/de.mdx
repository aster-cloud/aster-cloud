---
title: "Überblick"
description: "Die Aster Policy Engine ist ein produktionsreifer REST-Dienst zur Evaluierung von Geschäftsregeln, die in Aster CNL (Controlled Natural Language)…"
updated: 2026-06-02
apiVersion: v1
---
...
Anfragen, die den Zustand ändern oder sensible Eingaben enthalten, sollten zusätzlich HMAC-Signatur-Header enthalten. Das vollständige Signierprotokoll finden Sie unter [Authentifizierung](/de/docs/getting-started/authentication).
...
Richtlinien werden entweder als Quelltext eingereicht (spontan evaluiert) oder als gespeicherte, vorkompilierte und zwischengespeicherte Richtlinienobjekte. Details finden Sie in der [API-Referenz](/de/docs/api/policies/evaluate).

## Nächste Schritte

- [Authentifizierung](/de/docs/getting-started/authentication) — Mandanten-IDs, HMAC-Signierung und RBAC-Rollen konfigurieren
- [Schnellstart](/de/docs/getting-started/quickstart) — Ihre erste Richtlinienevaluierung in unter fünf Minuten
- [Fehlerbehandlung](/de/docs/getting-started/errors) — Fehlerantwortformate und häufige Fehlermodi verstehen
