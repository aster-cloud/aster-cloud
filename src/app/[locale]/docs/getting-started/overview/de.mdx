...
Anfragen, die den Zustand ändern oder sensible Eingaben enthalten, sollten zusätzlich HMAC-Signatur-Header enthalten. Das vollständige Signierprotokoll finden Sie unter [Authentifizierung](/docs/getting-started/authentication).
...
Richtlinien werden entweder als Quelltext eingereicht (spontan evaluiert) oder als gespeicherte, vorkompilierte und zwischengespeicherte Richtlinienobjekte. Details finden Sie in der [API-Referenz](/docs/api/policies/evaluate).

## Nächste Schritte

- [Authentifizierung](/docs/getting-started/authentication) — Mandanten-IDs, HMAC-Signierung und RBAC-Rollen konfigurieren
- [Schnellstart](/docs/getting-started/quickstart) — Ihre erste Richtlinienevaluierung in unter fünf Minuten
- [Fehlerbehandlung](/docs/getting-started/errors) — Fehlerantwortformate und häufige Fehlermodi verstehen
