...
description: "Understand Aster API error responses — the structured error envelope, HTTP status codes, validation violations, and how to handle rate limits and retries."
updated: 2026-06-02
apiVersion: v1
---
...
<Callout type="tip" title="Distinguishing evaluation errors from HTTP errors">
...
<Callout type="warning" title="If you receive a 500">
