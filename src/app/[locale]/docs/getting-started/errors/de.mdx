...
description: "Die Aster Policy Engine verwendet Standard-HTTP-Statuscodes und einen konsistenten JSON-Antwortumschlag für alle Fehlerbedingungen."
updated: 2026-06-02
apiVersion: v1
---
...
<Callout type="tip" title="Unterscheidung zwischen Evaluierungsfehlern und HTTP-Fehlern">
...
<Callout type="warning" title="Bei einem 500-Fehler">
