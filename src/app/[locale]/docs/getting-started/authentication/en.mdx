...
description: "Authenticate to the Aster policy API with tenant-scoped API keys — how to create, send, rotate, and revoke them, plus the tenant isolation model."
updated: 2026-06-02
apiVersion: v1
---
...
<Callout type="tip" title="Tenant ID conventions">
