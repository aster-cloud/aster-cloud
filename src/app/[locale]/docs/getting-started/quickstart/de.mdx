...
Wenn `error` nicht null ist, ist das `result`-Feld `null`. Eine vollständige Liste der Fehlerszenarien finden Sie unter [Fehlerbehandlung](/docs/getting-started/errors).
...
- [Authentifizierung](/docs/getting-started/authentication) — HMAC-Signierung zum Schutz Ihrer Anfragen hinzufügen
- [Überblick](/docs/getting-started/overview) — Die vollständigen Fähigkeiten der Policy Engine verstehen
- [Fehlerbehandlung](/docs/getting-started/errors) — Fehler in Ihrer Anwendung elegant behandeln
- [API-Referenz](/docs/api/policies/evaluate) — Vollständige Referenz für alle Endpunkte und Felder
