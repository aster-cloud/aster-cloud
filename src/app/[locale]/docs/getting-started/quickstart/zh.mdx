---
title: "快速开始"
description: "五分钟内完成第一次 Aster 策略评估——配置凭证、评估策略、读取决策结果，并尝试批量评估。"
updated: 2026-06-02
apiVersion: v1
---
...
本指南将带你在五分钟内完成第一次策略评估。下方的步骤会直接带你进入控制台；下方的参考章节展示完整的请求和响应结构。
...
如果 `error` 非空，`result` 字段将为 `null`。完整故障场景列表请参阅[错误处理](/zh/docs/getting-started/errors)。
...
- [认证](/zh/docs/getting-started/authentication) — 添加 HMAC 签名以保护你的请求
- [概述](/zh/docs/getting-started/overview) — 了解策略引擎的完整能力
- [错误处理](/zh/docs/getting-started/errors) — 在应用程序中优雅地处理故障
- [API 参考](/zh/docs/api/policies/evaluate) — 所有端点和字段的完整参考
