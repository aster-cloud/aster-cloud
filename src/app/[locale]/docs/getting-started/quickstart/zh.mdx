...
如果 `error` 非空，`result` 字段将为 `null`。完整故障场景列表请参阅[错误处理](/docs/getting-started/errors)。
...
- [认证](/docs/getting-started/authentication) — 添加 HMAC 签名以保护你的请求
- [概述](/docs/getting-started/overview) — 了解策略引擎的完整能力
- [错误处理](/docs/getting-started/errors) — 在应用程序中优雅地处理故障
- [API 参考](/docs/api/policies/evaluate) — 所有端点和字段的完整参考
