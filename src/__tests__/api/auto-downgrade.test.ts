...
const { mockFindMany, mockUpdate, mockUpdateSet: _mockUpdateSet, mockUpdateWhere: _mockUpdateWhere, mockUpdateReturning, mockInsertValues: _mockInsertValues, mockInsert } =
  vi.hoisted(() => {
