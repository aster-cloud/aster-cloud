...
export const DEMO_SUPPLEMENT: Record<Locale, MessageTree> = {
  en: {
    ...
    poemDemoPage: {
      ...
      eyebrow: 'Fun demo',
      title: 'The source is a poem 📜',
      subtitle: 'A famous poem in your language, lightly reshaped into Aster — read it top to bottom and it is the poem; compile it and it is a working program. Keyword aliases rename the structure words, a paren-free call hides the last bracket, and the same engine that decides a loan recites it.',
      source: {
        ...
        canonicalNote: 'Identical Core IR — the poem is an alias of this. (Module / Rule / If / Return / apply …)',
      },
      run: {
        title: 'And it runs — reciting the poem line by line',
        hint: 'The rule recurses, one line at a time, building the verse.',
        button: 'Recite the poem ▶',
      },
      result: {
        title: 'The engine recites',
  ...
  zh: {
    ...
    poemDemoPage: {
      ...
      eyebrow: '趣味 Demo',
      title: '源码即诗 📜',
      subtitle: '一首你所用语言的名诗，轻改成 Aster——从上往下读它就是那首诗，编译它就是一个能跑的程序。关键词别名改写了结构词，无括号调用藏起了最后一个括号，判定一笔贷款的同一套引擎在吟诵它。',
      source: {
        title: '把源码当诗读',
        hint: '每一行都读作诗句。但每个词都是真关键词（被别名）——引擎像编译任何规则一样编译它。',
        showCanonical: '看同一程序的规范关键词版 ↓',
        hideCanonical: '收起规范关键词版 ↑',
        canonicalNote: '完全相同的 Core IR——这首诗只是它的别名。（模块 / 规则 / 如果 / 返回 / 应用 …）',
      },
      run: {
        title: '它真的跑——递归把这首诗一句句吟出',
        hint: '规则递归执行，一次一句，逐行构成诗篇。',
        button: '吟诵这首诗 ▶',
      },
      result: {
        title: '引擎吟诵',
  ...
  de: {
    ...
    poemDemoPage: {
      ...
      eyebrow: 'Spaß-Demo',
      title: 'Der Quelltext ist ein Gedicht 📜',
      subtitle: 'Ein berühmtes Gedicht in deiner Sprache, behutsam in Aster umgeformt — von oben nach unten gelesen ist es das Gedicht; kompiliert ist es ein laufendes Programm. Schlüsselwort-Aliase benennen die Strukturwörter um, ein klammerfreier Aufruf verbirgt die letzte Klammer, und dieselbe Engine, die einen Kredit entscheidet, trägt es vor.',
      source: {
        ...
        canonicalNote: 'Identische Core-IR — das Gedicht ist ein Alias davon. (Modul / Regel / wenn / gib zurück / wende an …)',
      },
      run: {
        title: 'Und es läuft — trägt das Gedicht Zeile für Zeile vor',
        hint: 'Die Regel rekursiert, eine Zeile nach der anderen, und baut den Vers.',
        button: 'Das Gedicht vortragen ▶',
      },
      result: {
        title: 'Die Engine trägt vor',
  ...
  hi: {
    ...
    poemDemoPage: {
      ...
      eyebrow: 'मज़ेदार डेमो',
      title: 'स्रोत ही एक कविता है 📜',
      subtitle: 'आपकी भाषा की एक मशहूर कविता, हल्के से Aster में ढाली गई — ऊपर से नीचे पढ़ें तो यह वही कविता है; कंपाइल करें तो यह एक चलता प्रोग्राम है। कीवर्ड उपनाम संरचना-शब्दों का नाम बदलते हैं, एक बिना-कोष्ठक कॉल आखिरी कोष्ठक छिपाता है, और जो इंजन एक ऋण तय करता है वही इसे सुनाता है।',
      source: {
        ...
        canonicalNote: 'समान Core IR — यह कविता उसी का उपनाम है। (मॉड्यूल / नियम / यदि / लौटाएं / लागू करें …)',
      },
      run: {
        title: 'और यह चलता है — कविता को पंक्ति-दर-पंक्ति सुनाते हुए',
        hint: 'नियम पुनरावर्ती होता है, एक बार में एक पंक्ति, पद्य रचते हुए।',
        button: 'कविता सुनाएँ ▶',
      },
      result: {
        title: 'इंजन सुनाता है',
