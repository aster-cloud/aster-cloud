...
// 德语词法配置（与 aster-lang-ts 的 de-DE.ts 保持同步）
...
export function getKeywordsByCategory(lexicon: LexiconConfig) {
  return {
    ...
    type: [
      ...
      lexicon.keywords[SemanticTokenKind.TYPE_HAS],
      lexicon.keywords[SemanticTokenKind.TYPE_ONE_OF],
    ],
    function: [
      lexicon.keywords[SemanticTokenKind.FUNC_TO],
      lexicon.keywords[SemanticTokenKind.FUNC_GIVEN],
    ...
    control: [
      ...
      lexicon.keywords[SemanticTokenKind.RESULT_IS],
    ...
    operator: [
      ...
      lexicon.keywords[SemanticTokenKind.UNDER],
      lexicon.keywords[SemanticTokenKind.OVER],
      lexicon.keywords[SemanticTokenKind.MORE_THAN],
    ],
    literal: [
    ...
    constraint: [
      lexicon.keywords[SemanticTokenKind.REQUIRED],
      lexicon.keywords[SemanticTokenKind.BETWEEN],
      lexicon.keywords[SemanticTokenKind.AT_LEAST],
      lexicon.keywords[SemanticTokenKind.AT_MOST],
      lexicon.keywords[SemanticTokenKind.MATCHING],
      lexicon.keywords[SemanticTokenKind.PATTERN],
    ],
  };
}
